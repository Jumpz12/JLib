...
JLib.Config.Gravity.Spheres = {

    {
        ...
        raid = false,
        control = "Neutral",                   -- Who controls the planet originally
        attacker = "",
        progress = 0,
        control_points = {
...
JLib.Config.PlanetControl.SmallRaidTime = 10  -- How long players have to raid a planet
...
JLib.Config.PlanetControl.Minimum = 1 -- How many a side must have for a raid to be activated
